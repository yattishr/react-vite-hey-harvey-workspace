...
// This legacy suite mutates a real database and is intentionally excluded from deterministic CI.
// Run explicitly only against a disposable fixture database.
describe.skipIf(process.env.RUN_DATABASE_SMOKE_TESTS !== "true")(
  "Agent Orchestration Platform - Smoke Tests",
  () => {
